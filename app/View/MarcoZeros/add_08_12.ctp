...
<h1>Marco Zero de 08 á 12 Anos</h1>
<?php
...
echo $this->Form->input('vcor', array('label' => 'Você se considera:',"options"=>array(array('name'=>'Branco','value'=>'Branco'),array('name' =>'Negro','value'=>'Negro'),array('name' =>'Pardo','value'=>'Pardo'),array('name' =>'Indigena','value'=>'Indigena'),array('name' =>'Amarelo','value'=>'Amarelo')),
    "empty" => "Escolha uma opção"));

echo $this->Form->input('bomora', array('label' => 'O que você acha do Bairro onde Mora',"options"=>array(array('name'=>'Ruim','value'=>'Ruim'),array('name' =>'Mais ou Menos','value'=>'Mais ou Menos'),array('name' =>'Legal','value'=>'Legal'),array('name' =>'Muito Legal','value'=>'Muito Legal')),
    "empty" => "Escolha uma opção"));
	
echo $this->Form->input('ecomora', array('label' => 'O que você acha da Escola onde Estuda',"options"=>array(array('name'=>'Ruim','value'=>'Ruim'),array('name' =>'Mais ou Menos','value'=>'Mais ou Menos'),array('name' =>'Legal','value'=>'Legal'),array('name' =>'Muito Legal','value'=>'Muito Legal')),
"empty" => "Escolha uma opção"));
...
echo $this->Form->input('ovcqueser', array('label' => 'O que você quer ser quando crescer?'));
